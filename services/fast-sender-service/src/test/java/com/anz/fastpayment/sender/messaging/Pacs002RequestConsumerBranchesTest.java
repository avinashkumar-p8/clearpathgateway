...
class Pacs002RequestConsumerBranchesTest {
    ...
    @Test
    void originalXml_preferred_over_payload_and_error_uniqueId_set() throws Exception {
        Pacs002Service svc = mock(Pacs002Service.class);
        when(svc.handlePacs002Request(any(Pacs002Request.class))).thenReturn(new Pacs002Response("P4","ACCEPTED"));
        Pacs002RequestConsumer c = new Pacs002RequestConsumer(svc);
        String json = "{\"puid\":\"P4\",\"payload\":\"<y/>\",\"originalXml\":\"<x/>\",\"error\":\"E\",\"uniqueId\":\"U\"}";
