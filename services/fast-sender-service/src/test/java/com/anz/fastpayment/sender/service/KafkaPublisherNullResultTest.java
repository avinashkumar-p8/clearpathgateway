...
class KafkaPublisherNullResultTest {
    @Test
    void success_withNullResult_logsNoMetadata() {
        KafkaTemplate<String, GenericRecord> kt = mock(KafkaTemplate.class);
        CompletableFuture<org.springframework.kafka.support.SendResult<String, GenericRecord>> fut = CompletableFuture.completedFuture(null);
