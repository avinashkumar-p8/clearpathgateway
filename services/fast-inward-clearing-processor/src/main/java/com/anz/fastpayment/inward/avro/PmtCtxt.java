...
public class PmtCtxt extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<PmtCtxt> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<PmtCtxt> DECODER =
   ...
   */
  public static BinaryMessageEncoder<PmtCtxt> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PmtCtxt> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PmtCtxt> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this PmtCtxt to a ByteBuffer.
  ...
  /**
   * Deserializes a PmtCtxt from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a PmtCtxt instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static PmtCtxt fromByteBuffer(
   ...
   */
  public com.anz.fastpayment.inward.avro.IntnSrc getIntnSrc() {
    return IntnSrc;
  }
   ...
   * @param value the value to set.
   */
  public void setIntnSrc(com.anz.fastpayment.inward.avro.IntnSrc value) {
    this.IntnSrc = value;
  }

  /**
   * Creates a new PmtCtxt RecordBuilder.
   * @return A new PmtCtxt RecordBuilder
   */
  public static com.anz.fastpayment.inward.avro.PmtCtxt.Builder newBuilder() {
    return new com.anz.fastpayment.inward.avro.PmtCtxt.Builder();
  }

  /**
   * Creates a new PmtCtxt RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new PmtCtxt RecordBuilder
   */
  public static com.anz.fastpayment.inward.avro.PmtCtxt.Builder newBuilder(com.anz.fastpayment.inward.avro.PmtCtxt.Builder other) {
    if (other == null) {
      return new com.anz.fastpayment.inward.avro.PmtCtxt.Builder();
    } else {
      return new com.anz.fastpayment.inward.avro.PmtCtxt.Builder(other);
    }
  }

  /**
   * Creates a new PmtCtxt RecordBuilder by copying an existing PmtCtxt instance.
   * @param other The existing instance to copy.
   * @return A new PmtCtxt RecordBuilder
   */
  public static com.anz.fastpayment.inward.avro.PmtCtxt.Builder newBuilder(com.anz.fastpayment.inward.avro.PmtCtxt other) {
    if (other == null) {
      return new com.anz.fastpayment.inward.avro.PmtCtxt.Builder();
    } else {
      return new com.anz.fastpayment.inward.avro.PmtCtxt.Builder(other);
  ...
  /**
   * RecordBuilder for PmtCtxt instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PmtCtxt>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.anz.fastpayment.inward.avro.PmtCtxt.Builder other) {
      super(other);
      ...
      if (other.hasIntnSrcBuilder()) {
        this.IntnSrcBuilder = com.anz.fastpayment.inward.avro.IntnSrc.newBuilder(other.getIntnSrcBuilder());
      }
    }

    /**
     * Creates a Builder by copying an existing PmtCtxt instance
     * @param other The existing instance to copy.
     */
    private Builder(com.anz.fastpayment.inward.avro.PmtCtxt other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.PuId)) {
        this.PuId = data().deepCopy(fields()[0].schema(), other.PuId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anz.fastpayment.inward.avro.PmtCtxt.Builder clearPuId() {
      PuId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anz.fastpayment.inward.avro.PmtCtxt.Builder setIntnSrc(com.anz.fastpayment.inward.avro.IntnSrc value) {
     ...
     * @return This builder.
     */
    public com.anz.fastpayment.inward.avro.IntnSrc.Builder getIntnSrcBuilder() {
      if (IntnSrcBuilder == null) {
        if (hasIntnSrc()) {
          setIntnSrcBuilder(com.anz.fastpayment.inward.avro.IntnSrc.newBuilder(IntnSrc));
        } else {
          setIntnSrcBuilder(com.anz.fastpayment.inward.avro.IntnSrc.newBuilder());
        }
      }
    ...
    public com.anz.fastpayment.inward.avro.PmtCtxt.Builder setIntnSrcBuilder(com.anz.fastpayment.inward.avro.IntnSrc.Builder value) {
      clearIntnSrc();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anz.fastpayment.inward.avro.PmtCtxt.Builder clearIntnSrc() {
      IntnSrc = null;
      IntnSrcBuilder = null;
    ...
    public PmtCtxt build() {
      try {
        ...
        if (IntnSrcBuilder != null) {
          ...
          record.IntnSrc = fieldSetFlags()[1] ? this.IntnSrc : (com.anz.fastpayment.inward.avro.IntnSrc) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<PmtCtxt>
    WRITER$ = (org.apache.avro.io.DatumWriter<PmtCtxt>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<PmtCtxt>
    READER$ = (org.apache.avro.io.DatumReader<PmtCtxt>)MODEL$.createDatumReader(SCHEMA$);
